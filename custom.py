...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        data_file = open(os.path.join(dataset_dir,"obj_detect_json.json"))
        annotations1 = json.load(data_file)
        data_file.close()
        # annotations1 = json.load(open(r'E:\python_practice\mrcnn_obj_detect\dataset\train\obj_detect_json.json'))
        # print(annotations1)
